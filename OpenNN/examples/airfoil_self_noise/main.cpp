...
int main(void)
{
    try
    {
        ...
        if(1)
        {
          ...
          gradient_descent_pointer->set_maximum_epochs_number(1000);
          gradient_descent_pointer->set_display_period(10);

          gradient_descent_pointer->set_minimum_loss_decrease(1.0e-6);
        }
